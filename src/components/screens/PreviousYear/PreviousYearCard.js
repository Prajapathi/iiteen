...
export function PreviousYearCard(props) {
    ...
    const getPaper=()=>{
        ...
        db.collection("PREVIOUS").doc(props.paper.name).collection("Questions").get()
        .then(function(querySnapshot) {
            ...
            if(questions.length==0){
                ...
                //to check if user is navigating through PreviousYearCard
                localStorage.setItem("PaperName",props.paper.name)
                props.setLoading(false)
                history.push("PreviousYear/Papers/"+props.paper.name)
            }
            ...
            <div className="flip-card-inner-mock">
                <div className="flip-card-front-mock">
                    <div id="card-title-mock">
                        <div style={{fontSize:'26px'}}>{props.type=="advance"?"JEE Advance":"JEE Mains"}</div>
                    </div> 
                    <div id="card-content-mock">
                        ...
                        <div style={{display:'flex',width:'100%',justifyContent:'space-between'}}>
                            ...
                            <div style={{fontSize:'14px',color:'#448698'}}>{props.paper.totalDuration} </div>
                        </div>
                        <div style={{display:'flex',width:'100%',justifyContent:'space-between'}}>
                    ...
                    <div className="card-button-mock">
                        ...
                        {
                            props.isAttempted?
                                <Link to={"PreviousYear/Papers/Analysis/"+props.paper.name}>
...
export default connect(null,mapDispatchToProps)(PreviousYearCard)