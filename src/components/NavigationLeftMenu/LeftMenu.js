                ...
                {props.isAuthenticated ? (
                  <>
                    <Link to="/mjki@123U" className="menu-link">
                      <Typography className={clsx(classes.tabs)}>
                        Home{" "}
                      </Typography>
                    </Link>
                    ...
                    <Link to="/soon" className="menu-link">
                    <Typography className={clsx(classes.tabs)}>
                      IITeenCorner{" "}
                    </Typography>
                    </Link>
                    ...
                    <Badge
                      style={{}}
                      className={clsx(classes.notifBadge)}
                      overlap="circle"
                      badgeContent={0}
                      color="primary"
                    >
                      ...
                      >
                        <div className={clsx(classes.logoutConfirmMessage)}>
          ...
          >
            <div className={classes.menuHead}>
              ...
              <div className="profile-pic-container">
                <img
                  src={props.user.photoURL ? props.user.photoURL : avatar}
                  className="left-menu-profile-pic"
                />
                {openEditImage ? null : (
              ...
              {openEditImage ? (
                <EditImage closeEdit={() => setOpenEditImage(false)} />
              ) : null}

              <div className={classes.name}>
                {openEditName ? (
                  <EditName
                    closeEdit={() => setOpenEditName(false)}
                    data={props.user ? props.user.displayName : null}
                  />
                ) : (
                  <Typography
                    variant="h6"
            ...
            <List>
              {["My Purchases", "Ask Experts", "Study Materials"].map(
                (text, index) => (
