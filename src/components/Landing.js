  ...
  return (
    <div id="landingpage">
      {openLogin || openSignup ? (
        <Signin
          openLogin={openLogin || openSignup}
          login={openLogin}
          setOpenLogin={setOpenLogin}
          setOpenSignup={setOpenSignup}
          closeLogin={
            openLogin ? () => setOpenLogin(false) : () => setOpenSignup(false)
          }
        />
      ) : null}
      <div
      ...
      >
        <div id="app-bar">
          <div id="app-bar-open" onClick={() => setOpen(!open)}>
            {open ? (
              <ChevronRightIcon style={{ fontSize: "38px" }} />
            ) : (
      ...
      <div id="section1">
        ...
        <div id="section1-text">
          ...
          <h1 id="section1-heading-line1">
            Are you Preparing for <b>JEE</b>?
          </h1>
          <h1 id="section1-heading-line2">
            <b>CRACK</b> IIT JEE with <b>IITeens</b>
          </h1>
          <p style={{ fontSize: "20px" }}>
            IITeens conducts online Test Series for Concept Building, Learning
            and Development of Basics of the JEE aspirants through in-depth
            Technical Analysis learned through Test Series accelerates the
            performance ​
          </p>
          <div id="section1-text-div">
            ...
            setOpenLogin(false)}
                ...
                Not already a user? Sign Up now
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="section3">
        <div className="sub-section3">
          ...
          <div className="sub-section3-sub-div">
            <div className="sub-section3-sub-heading">Ask with Experts</div>
            <p>Coming Soon...</p>
          </div>
        </div>
        <div className="sub-section3">
          ...
          <div className="sub-section3-sub-div">
            ...
            <p>
              Graphical Form of Report for better feedback and also improving
              performance
            </p>
          </div>
        </div>
        <div className="sub-section3">
          ...
          <div className="sub-section3-sub-div">
            ...
            <p>
              <a target="_blank" href="https://www.dictionary.com/">
                www.dictionary.com
              </a>
            </p>
          </div>
            ...
            <div>
              <div className="sub-section4-list-section">
                <ul>
                  ...
                  <li>
                    3 Level of Difficulty to enhance step by step concept
                    building
                  </li>
                  <li>15 Mock Test  for self analysis</li>
                  <li>
                    48 AITS for performance checking with all India JEE
                    aspirants{" "}
                  </li>
                  <li>
                    New Pattern Followed & Full Analysis of all Tests to know
                    the performance ​
                  </li>
                  ​
                </ul>
      ...
      <div id="section5">
        <div id="batchmates-title">
          In loving memory of our beloved 1988 JEE Qualified IIT Kharagpur
          batchmates who left us early for heavenly abode
        </div>
        <div id="batchmates-list">
          <ol>
            ...
            <li>
              {" "}
              Nina Saxena, Electronics and Electrical Communication Engineering
            </li>
            <li>
              {" "}
              Nilanjan Ganguly, Electronics and Electrical Communication
              Engineering
            </li>
